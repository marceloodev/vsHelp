...
cfg_helpCommand = "help" -- Coloque o nome do comando para pedir ajuda (OBS: Sem barra "/")

cfg_Name = "[vsHelp]" -- Nome do script quando ele mandar a mensagem no chat, Caso queira mudar para o nome de sua cidade fique a vontade.

-- Para configurar a cor do script quando ele mandar mensagem no chat ir no arquivo (vs-client/linha 13) La terá outro tutorial de como alterar a cor.
