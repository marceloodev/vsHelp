...
cfg.Color = "0,0,255" -- Cor do script quando ele mandar mensagem no chat. As cores são em RGB para saber qual utilizar entrar nesse site: https://www.peko-step.com/pt/tool/tfcolor.html
